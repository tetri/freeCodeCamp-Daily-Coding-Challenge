...
test("daysUntilWeekend 1", () => {
  expect(daysUntilWeekend("2025-11-14")).toStrictEqual(
    "1 day until the weekend."
  );
});

test("daysUntilWeekend 2", () => {
  expect(daysUntilWeekend("2025-01-01")).toStrictEqual(
    "3 days until the weekend."
  );
});

test("daysUntilWeekend 3", () => {
  expect(daysUntilWeekend("2025-12-06")).toStrictEqual("It's the weekend!");
});

test("daysUntilWeekend 4", () => {
  expect(daysUntilWeekend("2026-01-27")).toStrictEqual(
    "4 days until the weekend."
  );
});

test("daysUntilWeekend 5", () => {
  expect(daysUntilWeekend("2026-09-07")).toStrictEqual(
    "5 days until the weekend."
  );
});

test("daysUntilWeekend 6", () => {
  expect(daysUntilWeekend("2026-11-29")).toStrictEqual("It's the weekend!");
});
